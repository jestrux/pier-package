...
<template>
  <div v-if="noCard" class="PierCard ProfileCard shadow rounded-lg overflow-hidden bg-white text-black px-5 pt-5 pb-4">
  </div>
  
  <div v-else class="PierCard ProfileCard shadow-md rounded-lg overflow-hidden bg-white text-black px-5 pt-5 pb-4">
...
<script>
import PierCardHeading from "../CardComponents/PierCardHeading";
